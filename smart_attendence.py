...
# one by one fetch and append
for cl in myList :
    cur_img = cv2.imread(f'{path}/{cl}')
    studentImg.append(cur_img)
    studentName.append(os.path.splitext(cl)[0])
# encoding to differentiate
...
def MarkAttendence(name):
    with open('arrendence.csv', 'r+') as f:
